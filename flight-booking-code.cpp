...
public://public member functions
    ...
    int j_detail() // function declaration and definition for domestic journey
    {
        ...
        cin >> doj;
        cout << "\n\1.Mumbai(1) \t\2.Kolkata(2) \t\3.Chennai(3) \t\4.Delhi(4)" << endl << endl;
        cout << "\tEnter Source: ";
        cin >> src;
        ...
        if((src==1 && dest==2) || (src==2 && dest==1))//condition
        {
            ...
            cout << "\2.AirIndia(2)\t14:00\t\t17:05\t\tRs.5500\t\tRefundable\n";
        ...
        else if((src==1 && dest==4) || (src==4 && dest==1))//condition
        {
            ...
            cout << "\2.AirIndia(2)\t14:00\t\t17:05\t\tRs.4250\t\tRefundable\n";
        ...
        else if((src==2 && dest==3) || (src==3 && dest==2))//condition
        {
            ...
            cout << "\2.AirIndia(2)\t14:00\t\t17:05\t\tRs.2500\t\tRefundable\n";
        ...
        else if((src==2 && dest==4) || (src==4 && dest==2))//condition
        {
        ...
        else if((src==3 && dest==4) || (src==4 && dest==3))//condition
         {
            ...
            cout << "\2.AirIndia(2)\t14:00\t\t17:05\t\tRs.5508\t\tRefundable\n";
    ...
    {   cout << "\nEnter your choice: ";
        ...
        switch(choice) // switch case
        {
          ...
          case 2://condition
                cout << "\nFlight selected:"<<endl;
                cout << "AirIndia"<<endl;
                strcpy(f_d,"AirIndia");//copy to string
...
public://public member functions
    ...
    {
        cout << "Enter DateOfJourney(DDMMYY)." << "Please enter a valid date. : ";
        cin >> doji;
        cout << "\n\1.London(1) \2.Dubai(2) \3.Abu Dhabi(3) \4.Singapore(4) \5.NewYork(5) " << endl << endl;
        cout << "\tEnter Source: ";
        cin >> srci;
        cout << "\nEnter destination: ";
        cin >> desti;
...
public://public member functions
    ...
    {
        cout << "\nGender:\nMale-press:1::\nFemale-press:2::\nNon-Binary-press:3::\nPrefer not to say-press:4:: ";
        cin >> gender;
        if(gender>4)//condition
        {
            cout << "\n\nWrong input entered.\nTry again\n\n" << endl;
...
public://public members functions
    ...
    {     cout << "\n\n\nHow would you like to pay?:\n";
        ...
        case 2://condition
            ...
            break;
        case 3://condition
            cout << "Banks Available: \1.Axis Bank(1) \2.State Bank of India(2) \3.HDFC Bank(3) \4.ICICI Bank(4) \5.Others(5)";
            cout << "\nSelect your bank:";
            cin >> bank;
